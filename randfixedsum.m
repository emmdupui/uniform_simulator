%
%
%  Code taken from Roger Stafford - Jan. 19, 2006
%  Code found in Techniques For The Synthesis Of Multiprocessor Tasksets by Roger Stafford et al.
%
%
%
...
% of s and divided by 0sqrt(n), is integrated with respect to s
